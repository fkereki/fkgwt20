...
public class CityCreatorPresenter
  ...
  public CityCreatorPresenter(
      final String params,
      final CityCreatorDisplay cityCreatorDisplay,
    ...
    getDisplay().setOnAddClickCallback(
    ...
    SimpleCallback<Object> ch= new SimpleCallback<Object>() {
      ...
      public void goBack(
        ...
        final String country= getDisplay().getCountryState()
            .getCountry();
        final String region= getDisplay().getCountryState()
            .getState();
        ...
        if (!country.isEmpty() && !region.isEmpty()
          ...
          getEnvironment().getModel().getRemoteWorldService()
              .cityExists(country, region, city,
                  new AsyncCallback<Boolean>() {
                    ...
                    public void onSuccess(
                      ...
                      if (originalCountry.equals(getDisplay()
                          ...
                          && originalRegion.equals(getDisplay()
                              .getCountryState().getState())
                          && originalCityName
                              .equals(getDisplay().getCityName())) {
