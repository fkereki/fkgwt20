...
public class FeedsListingView
    extends View
    implements FeedsListingDisplay {

  @UiTemplate("FeedsListingView.ui.xml")
  interface Binder
      extends UiBinder<HTMLPanel, FeedsListingView> {
  }
