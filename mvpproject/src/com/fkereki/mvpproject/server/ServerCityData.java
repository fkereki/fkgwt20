...
public class ServerCityData extends ClientCityData {
   ...
   * restricted client-side objects.
   * 
   * Usually (but not in this example) the server-side object will have a few
   * more attributes than the client-side one.
   * 
   * @param pObject
   ...
   * in case we have to return such an object to the client.
   * 
   * Usually this just entails creating the new object from selected attributes
   * of the current object, and discarding other ones.
   * 
